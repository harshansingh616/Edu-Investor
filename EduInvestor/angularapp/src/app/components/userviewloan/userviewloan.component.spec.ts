...
describe('UserviewloanComponent', () => {
  ...
  fit('Frontend_should_contain_available_educational_loans_heading_in_the_userviewloan_component', () => {
    const componentHTML = fixture.debugElement.nativeElement.outerHTML;
    expect(componentHTML).toContain('Available Educational Loans');
  });
});
